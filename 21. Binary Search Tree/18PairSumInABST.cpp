...
Pair sum in a BST
Send Feedback
Given a binary search tree and an integer S, find pair of nodes in the BST which sum to S. You can use extra space 
of the order of O(log n).
Note:
...
{ 
    ...
    { 
        ...
        { 
            ...
            BinaryTreeNode<int> *top = inorderTop; inorder.pop(); count++; 
        ...
        { 
            BinaryTreeNode<int> *top = revInorderTop; revInorder.pop(); 
            count++; 
